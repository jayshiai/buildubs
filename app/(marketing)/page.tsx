...
import { CodeXml, Webhook } from "lucide-react"
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Yet-Another-Component-Library made on top of <b>Radix UI </b> and{" "}
            <b>TailwindCSS</b> with{" "}
            <u className=" cursor-pointer">
              <EmulateKeydown keyToEmulate={"T"}>a theme editor</EmulateKeydown>
            </u>
            . It is created with aim of providing a simple and easy to use
            component library.
          </p>
        </div>
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Get ready to use code snippets for your website directly from
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Create your own Theme using the Theme Editor. Press{" "}
                  <EmulateKeydown keyToEmulate={"T"}>
                    <Button
                      variant="outline"
                      size="icon"
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              <div className="relative">
                <Icons.sun className="rotate-0 scale-[1.75] transition-all duration-500 dark:-rotate-90 dark:scale-0" />
                <Icons.moon className="absolute top-2 rotate-90 scale-0 transition-all duration-500 dark:rotate-0 dark:scale-[1.75]" />
              </div>
              <div className="space-y-2">
                <h3 className="font-bold">Theming</h3>
                <p className="text-sm text-muted-foreground">
                  Create your own Light and Dark Theme. Switch by pressing{" "}
                  <EmulateKeydown keyToEmulate={"D"}>
                    {" "}
                    <Button
                      variant="outline"
                      size="icon"
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">React Components</h3>
                <p className="text-sm text-muted-foreground">
                  Use pre-styled components or create your own using granular
                  components.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto text-center md:max-w-[58rem]">
          <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            ...
            for extensive information on how to use the components.
          </p>
        </div>
      </section>
